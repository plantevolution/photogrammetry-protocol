...
software.](Figures/Color chart sRGB values.pdf){#fig:xrite_description
width="7cm"}
...
![Adobe DNG
Converter](Figures/logo Adobe DNG Converter.png){width="40%"}

![ColorChecker Camera
Calibration](Figures/logo ColorChecker Camera Calibration.png){width="60%"}

![Adobe Lightroom Classic](Figures/logo Lrc.png){width="30%"}
