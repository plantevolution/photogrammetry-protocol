...
7.  Take a picture of the color chart (RAW). Make sure to Incorporate
    ...
    [13](#colorchart){reference-type="ref" reference="colorchart"}).

![Colour chart photo taken at the beginning of the process to calibrate
the photos in post process.](Figures/chart_example.png){#colorchart
width="30%"}
...
>For Gesneriaceae, we first suggest a standard orientation [14](#flowerplacement_1){reference-type="ref"
reference="flowerplacement_1"}) and an
upside-down position (Figure
[15](#flowerplacement_2){reference-type="ref"
reference="flowerplacement_2"}) of the flower as this generally gives satisfactory
results . For more complex flowers, three
positions may be required: horizontal, vertical, and upside down (Figure
[16](#flowerplacement_3){reference-type="ref"
reference="flowerplacement_3"}).
...
1.  Clip the camera on the flexible tripod (gorillapod) and place the
    ...
    [14](#flowerplacement_2){reference-type="ref"
    reference="flowerplacement_2"}). Make sure to not use different
...
![Camera position 1](Figures/camera_position_1.JPG){width="90%"}

![Camera position 2](Figures/camera_position_2.JPG){width="90%"}

![Camera position 3](Figures/camera_position_3.JPG){width="90%"}

![](Figures/position_2.jpg){width="90%"}

![](Figures/position_5.jpg){width="90%"}

![](Figures/flowerplacement_1.png){#flowerplacement_2 width="90%"}

![](Figures/flowerplacement_2.jpg){#flowerplacement_2 width="90%"}

![](Figures/flowerplacement_3.jpg){#flowerplacement_3 width="90%"}
...
[15](#flowerplacement_3){reference-type="ref" reference="#flowerplacement_3"}). On the
