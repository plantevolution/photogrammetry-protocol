...
results (Figure
[\[flowerplacement_2\]](#flowerplacement_2){reference-type="ref"
reference="flowerplacement_2"}). For more complex flowers, three
positions may be required: horizontal, vertical, and upside down (Figure
[\[flowerplacement_3\]](#flowerplacement_3){reference-type="ref"
...
![](Figures/camera_position_1.JPG){width="90%"}

![](Figures/camera_position_2.JPG){width="90%"}

![](Figures/camera_position_3.JPG){width="90%"}

![](Figures/position_2.jpg){width="90%"}

![](Figures/position_5.jpg){width="90%"}

![](Figures/flowerplacement_1.png){width="90%"}

![](Figures/flowerplacement_2.jpg){width="90%"}

![](Figures/flowerplacement_3.jpg){#3placement width="90%"}
...
[14](#3placement){reference-type="ref" reference="3placement"}). On the
