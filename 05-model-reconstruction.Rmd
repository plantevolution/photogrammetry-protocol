...
buttons (Figure \@ref(fig:tools_masks)). You can then use the selection tools to
select areas that are not the flower and add the selection to the mask
(Figure  \@ref(fig:tools_masks)). You also remove the scale and the
...
```{r toolsmasks, echo=FALSE, message=FALSE, fig.cap="Selection tools and add selection to mask tool.", out.width = '80%', fig.align='center',fig.show = 'hold'}
